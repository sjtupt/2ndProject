...
Module Name:
  ...
  PlatformToDriverConfigurationProtocol.c

Abstract:

  Platform To Driver Configuration protocol as defined in the UEFI 2.1 specification.
...
EFI_GUID_STRING(&gEfiPlatformToDriverConfigurationProtocolGuid, "Platform To Driver Configuration Protocol", "UEFI 2.10 Platform To Driver Configuration Protocol");
