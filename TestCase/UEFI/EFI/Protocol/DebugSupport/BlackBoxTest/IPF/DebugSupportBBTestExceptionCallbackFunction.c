  ...
  )
{
  ...
  Status = DebugSupport->RegisterExceptionCallback (DebugSupport, 0, ExceptionCallback, EXCEPT_IPF_BREAKPOINT);
  ...
  //
  Status = DebugSupport->RegisterExceptionCallback (DebugSupport, 0, ExceptionCallback1, EXCEPT_IPF_BREAKPOINT);
  ...
  //
  Status = DebugSupport->RegisterExceptionCallback (DebugSupport, 0, NULL, EXCEPT_IPF_BREAKPOINT);
