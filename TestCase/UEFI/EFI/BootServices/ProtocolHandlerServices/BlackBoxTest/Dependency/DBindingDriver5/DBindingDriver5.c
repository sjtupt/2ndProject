...
//
// DriverBindingDriver5:
// Open InterfaceTestProtocol1 BY_DRIVER | EXCLUSIVE;
// Open InterfaceTestProtocol2 BY_DRIVER | EXCLUSIVE;
// Open InterfaceTestProtocol3 BY_DRIVER | EXCLUSIVE
// Open InterfaceTestProtocol4 BY_DRIVER | EXCLUSIVE
  ...
  )
{
  ...
  LoadedImageInfoPtr->Unload = DBindingDriver5Unload;
  ...
  )
{
  ...
  PrivateData = DBINDING_DRIVER_5_PRIVATE_DATA_FROM_DRIVER_BINDING (This);
  ...
  if (PrivateData->Handle == NULL) {
    PrivateData->ExProt1.GetNextStatusReport = DBindingDriver5GetNextStatusReport;
  ...
  )
{
  ...
  PrivateData = DBINDING_DRIVER_5_PRIVATE_DATA_FROM_THIS (This);
...
{
  DriverBinding->Supported            = DBindingDriver5BindingSupported;
  DriverBinding->Start                = DBindingDriver5BindingStart;
  DriverBinding->Stop                 = DBindingDriver5BindingStop;
