...
EFI_FORWARD_DECLARATION(TEST_PROTOCOL_1);
...
EFI_FORWARD_DECLARATION(TEST_PROTOCOL_2);
...
EFI_FORWARD_DECLARATION(INTERFACE_FUNCTION_TEST_PROTOCOL_1);
...
EFI_FORWARD_DECLARATION(INTERFACE_FUNCTION_TEST_PROTOCOL_2);
...
EFI_FORWARD_DECLARATION(INTERFACE_FUNCTION_TEST_PROTOCOL_3);
...
EFI_FORWARD_DECLARATION(INTERFACE_FUNCTION_TEST_PROTOCOL_4);
...
EFI_FORWARD_DECLARATION(INTERFACE_FUNCTION_TEST_PROTOCOL_5);
...
EFI_FORWARD_DECLARATION(INTERFACE_FUNCTION_TEST_PROTOCOL_6);
...
EFI_FORWARD_DECLARATION(INTERFACE_FUNCTION_TEST_PROTOCOL_7);
...
EFI_FORWARD_DECLARATION(INTERFACE_FUNCTION_TEST_PROTOCOL_8);
...
EFI_FORWARD_DECLARATION(INTERFACE_FUNCTION_TEST_PROTOCOL_9);
...
EFI_FORWARD_DECLARATION(INTERFACE_FUNCTION_TEST_PROTOCOL_10);
...
EFI_FORWARD_DECLARATION(INTERFACE_FUNCTION_TEST_PROTOCOL_11);
...
EFI_FORWARD_DECLARATION(EXTERNAL_DRIVER_PROTOCOL_1);
