  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.ControlTransfer - ControlTransfer() returns EFI_INVALID_PARAMETER with IsSlowDevice is TRUE, MaximumPacketLength is 2",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.ControlTransfer - ControlTransfer() returns EFI_INVALID_PARAMETER with IsSlowDevice is FALSE, MaximumPacketLength is 128",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.ControlTransfer - ControlTransfer() returns EFI_INVALID_PARAMETER with IsSlowDevice is TRUE, MaximumPacketLength is 9",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.ControlTransfer - ControlTransfer() returns EFI_INVALID_PARAMETER with IsSlowDevice is FALSE, MaximumPacketLength is 9",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.ControlTransfer - ControlTransfer() returns EFI_INVALID_PARAMETER with TransferResult is NULL",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.BulkTransfer - BulkTransfer() returns EFI_INVALID_PARAMETER with Data is NULL",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.BulkTransfer - BulkTransfer() returns EFI_INVALID_PARAMETER with DataLength is 0",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.BulkTransfer - BulkTransfer() returns EFI_INVALID_PARAMETER with MaximumPacketLength is 2",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.BulkTransfer - BulkTransfer() returns EFI_INVALID_PARAMETER with DataToggle pointing to a value other than 0 and 1",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.BulkTransfer - BulkTransfer() returns EFI_INVALID_PARAMETER with TransferResult is NULL",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.AsyncInterruptTransfer - AsyncInterruptTransfer() returns EFI_INVALID_PARAMETER with invalid EndPointAddress",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.AsyncInterruptTransfer - AsyncInterruptTransfer() returns EFI_INVALID_PARAMETER with DataLength is 0",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.AsyncInterruptTransfer - AsyncInterruptTransfer() returns EFI_INVALID_PARAMETER with DataToggle points to a value other than 0 and 1",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.AsyncInterruptTransfer - AsyncInterruptTransfer() returns EFI_INVALID_PARAMETER with PollingInterval is not in the range 1..255",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.SyncInterruptTransfer - SyncInterruptTransfer() returns EFI_INVALID_PARAMETER with invalid EndPointAddress",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.SyncInterruptTransfer - SyncInterruptTransfer() returns EFI_INVALID_PARAMETER with Data is NULL",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.SyncInterruptTransfer - SyncInterruptTransfer() returns EFI_INVALID_PARAMETER with DataLength being 0",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.SyncInterruptTransfer - SyncInterruptTransfer() returns EFI_INVALID_PARAMETER with MaxiumPacketLenth is not valid",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.SyncInterruptTransfer - SyncInterruptTransfer() returns EFI_INVALID_PARAMETER with DataToggle points to a value other than 0 and 1",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.SyncInterruptTransfer - SyncInterruptTransfer() returns EFI_INVALID_PARAMETER with TransferResult is NULL",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.AsyncIsochronousTransfer - AsyncIsochronousTransfer() returns EFI_INVALID_PARAMETER with Data is NULL",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.AsyncIsochronousTransfer - AsyncIsochronousTransfer() returns EFI_INVALID_PARAMETER with DataLength is 0",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.IsochronousTransfer - IsochronousTransfer() returns EFI_INVALID_PARAMETER with Data is NULL",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.IsochronousTransfer - IsochronousTransfer() returns EFI_INVALID_PARAMETER with DataLength is 0",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.IsochronousTransfer - IsochronousTransfer() returns EFI_INVALID_PARAMETER with TransferResult is NULL",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
  ...
  )
{
  ...
  StandardLib->RecordAssertion (
                 ...
                 L"USB_HC_PROCOTOL.GetRootHubPortNumber - GetRootHubPortNumber() returns EFI_INVALID_PARAMETER with Invalid Parameters",
                 L"%a:%d:Status - %r",
                 __FILE__,
                 (UINTN)__LINE__,
                 Status
